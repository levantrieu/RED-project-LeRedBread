 ...
 *
 * @package   Le Red Bread Business Hours
 * @author    Levan Trieu <le_van_trieu@hotmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2016 Le Red Bread
 *
 * @wordpress-plugin
 * Plugin Name:       Le Red Bread Business Hours Widget
 * Plugin URI:        http://www.levantrieu.com/
 * Description:       Business hours widget to manage hours on website.
 * Version:           1.0.0
 * Author:            Levan Trieu
 * Author URI:        http://www.levantrieu.com/
 * License:           GPL-2.0+
